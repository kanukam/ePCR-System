...
export default class ChartForm extends Component {
    ...
    // delete added vitals from the display table
    deleteVitals = index => {
        var vital_signs = this.state.vital_signs;
        vital_signs.splice(index, 1);
        this.setState({ vital_signs });
    }
    ...
    handleSubmit = (event) => {
        ...
        if (this.state.idate === "" || this.state.loctype === "" || this.state.loc === "" || this.state.disp === "" || this.state.dest === "" || this.state.unit === "" || this.state.ctype === "" || this.state.nature === "" || this.state.dispatch === "" || this.state.enroute === "" || this.state.arrscn === "" || this.state.contact === "" || this.state.dptscn === "" || this.state.arrdes === "" || this.state.trcare === "" || this.state.crew1 === "" || this.state.lname === "" || this.state.fname === "" || this.state.gender === "" || (this.state.birth === "" && this.state.age === "")) {
            ...
            if (this.state.assessmentCheckBoxes[269]) {
                ...
                vehicle_accident_safety_equipment = this.state.vasafe.join();
            ...
            const p_regular_medicine = this.state.regMed;
            ...
            if (p_past_medical_history || this.state.assessmentCheckBoxes[321]) { p_past_medical_history += ", [O - Otro:" + this.state.pastHistoryOther + "]"; }
            // chart assessment
            ...
            if (this.state.assessmentCheckBoxes[260]) {
            ...
            let vital_signs = "";
            if (this.state.assessmentCheckBoxes[261]) { vital_signs = this.state.vital_signs.join(); }
            ...
            let intake_vomit = "";
            if (this.state.assessmentCheckBoxes[323]) {
            ...
            let obstetrics = "";
            if (this.state.assessmentCheckBoxes[324]) {
